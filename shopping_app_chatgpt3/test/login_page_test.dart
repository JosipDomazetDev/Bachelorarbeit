...
void main() {
  testWidgets('Successful login navigates to next view', (tester) async {
    ...
    await tester.enterText(find.byKey(const Key('usernameField')), 'valid_username');
    await tester.enterText(find.byKey(const Key('passwordField')), 'valid_password');
